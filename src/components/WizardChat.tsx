  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-shrink-0 flex items-center justify-between p-3 pt-[env(safe-area-inset-top,12px)] md:pt-3">
          <div className="md:hidden">
            <img
              ...
              width={48}
              height={48}
              className="border-2 border-primary/60 rounded-sm image-pixelated"
